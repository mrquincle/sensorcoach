...
var api = require('./src/api').interface;
api.createAPI(app);
...
app.get('/sessions/connect', function(req, res){
	consumer().getOAuthRequestToken(function(error, oauthToken, oauthTokenSecret, results){
		if (error) {
			...
			// responding by res.send() would require the client-site to do the cross-site redirection...
			// and then it's a pity that they do not get the res object of /sessions/callback, however, the client-site needs to know it, or else how is the window
			// object refreshed?
